<?php
/*
Plugin Name: Cleancoded Admin Page
Plugin URI: http://cleancoded.com
Description: Cleancoded WP Admin Page
Version: 1.0
Author: Cleancoded
Author URI: https://github.com/cleancoded/wp-admin-page
*/
  ...
  $config = array(    
    ...
    'page_title'     => __('Admin Page','apc'),       //The name of this page 
   ...
   */
  $options_panel = new CLEANCODED_Admin_Page_Class($config);
